...
#define ONE_THROUGH_18(some_macro, args...) \
	ONE_THROUGH_16(some_macro, args) \
	some_macro(args, 17) \
	some_macro(args, 18)
...
typedef struct
{
	...
	ONE_THROUGH_18(struct_key_val_n, Panel_Differ_Max_Tx)
	ONE_THROUGH_18(struct_key_val_n, Panel_Differ_Min_Tx)
