			    ...
			    const char *value)
{
	...
	ONE_THROUGH_18(POPULATE_CONFIG_KEY_VAL_RANGE, Panel_Differ_Max_Tx)
	ONE_THROUGH_18(POPULATE_CONFIG_KEY_VAL_RANGE, Panel_Differ_Min_Tx)
...
int read_config(configuration *pconfig)
{
	...
	ONE_THROUGH_18(COUNT_TX, Panel_Differ_Max_Tx, total_panel_differ_max_tx)
	// ONE_THROUGH_18(COUNT_TX, Panel_Differ_Min_Tx, total_panel_differ_min_tx)
	...
	ONE_THROUGH_18(APPEND_TX_VAL, Panel_Differ_Max_Tx, panel_differ_max_tx)
	...
	ONE_THROUGH_18(APPEND_TX_VAL, Panel_Differ_Min_Tx, panel_differ_min_tx)
